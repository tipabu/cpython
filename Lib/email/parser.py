...
class Parser:
    ...
    def parsestr(self, text, headersonly=False, strictheaders=True):
        ...
        the file.
        """
        return self.parse(StringIO(text), headersonly=headersonly, strictheaders=strictheaders)
...
class BytesHeaderParser(BytesParser):
    def parse(self, fp, headersonly=True, strictheaders=True):
        return BytesParser.parse(self, fp, headersonly=True, strictheaders=strictheaders)

    def parsebytes(self, text, headersonly=True, strictheaders=True):
        return BytesParser.parsebytes(self, text, headersonly=True, strictheaders=strictheaders)
